      ...
      { theme => {
        return(
          <ul className={styles.menu}>
              ...
              <li><Link to="/researchthreads/"><TranslatedPhrase translations={translations} phrase={"archive"}/></Link></li>
      ...
      return(
        <div>
          ...
          <div className={styles.langWrapper}>
            ...
            <select aria-label="select language" className={styles.lang} onChange={handler} name="lang" id="lang" value={theme.lang}>
              {/* <option style={{"display":"none"}} selected>Select language</option> */}
            { globalLanguages.map(function(language, index){
                return(<option key={index} value={language.code}>{language.name}</option>)
              })}
