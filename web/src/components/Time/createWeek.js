  ...
  console.log(week, ":)")
    ...
    function processDay(arr, d){
      ...
      uniqueArr.forEach(function(event, i){
        console.log(event[0].getDate(), event[1].getDate(), day)
        ...
        dayEvents.forEach(function(event){
          if(event[0].getDate() == event[1].getDate()){
            ...
            dayContent.push(
              <Link className={styles.multiDayWeek} to={'/event/'+ event[2].slug.current}><TranslatedTitle translations={event[2].titles}/></Link>
            )
          }
        ...
        multiEvents.forEach(function(event,i){
          ...
          if((event[1].getDate() - event[0].getDate()) >= 3 && (day - event[0].getDate()) == Math.floor((event[1].getDate() - event[0].getDate())/2)){
            dayContent.push(
              <Link className={styles.multiDayWeek + " " + styles.mid} to={'/event/'+ event[2].slug.current}><TranslatedTitle translations={event[2].titles}/></Link>
            )
          }else{
            dayContent.push(
              <Link className={styles.multiDayWeek} to={'/event/'+ event[2].slug.current}><TranslatedTitle translations={event[2].titles}/></Link>
